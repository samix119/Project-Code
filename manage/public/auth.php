...
if(isset($_POST['local'])) {
	...
	$retval = localauth($username,$password);

	if ( $retval == 1 ) {
		session_start();
		$_SESSION['username'] = $username;
		$id = session_id();
		syslog(LOG_NOTICE, "manage: auth.php: client: {$_SERVER['REMOTE_ADDR']}, user: $user, sess_id: $id, login successful");
...
<img id="top" src="viva.png" />
<form id="login" method="post" action=""> 

    <h1>Viva | Server Management</h1>
    ...
    <p class="forgot"><a href="provider.php?google">Login with Google</a>&nbsp;&nbsp;<a href="provider.php?yahoo">Login with Yahoo!</a>&nbsp;&nbsp;</p>
    <div class="submit">
        <button type="submit" name="local">Log in</button>   
